...
let findDiv = document.querySelector('.find')
...
function setSize(doc, el, sizeRatio) {
    ...
    el.setAttribute('height', parseInt(el.getAttribute('width')) * 0.01 * sizeRatio + 'px' )
    findDiv.style.right = (doc.offsetWidth - document.querySelector('.container').offsetWidth) / 2 + 'px'
}
